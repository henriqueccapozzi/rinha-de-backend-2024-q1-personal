...
CREATE ROLE myuser;
ALTER ROLE myuser WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:ZI7msL53+3gGM+4Fw3aqtA==$eVW4KFLO8WffFU7iu7yyfw4V4cWYd5ohM2XZ/OmkKVw=:rNBY8ACWjWQ1J9cfC5VOoVVbghYZ4apC455lddC3Ldk=';
...
--
-- Name: crebito; Type: DATABASE; Schema: -; Owner: myuser
--

CREATE DATABASE crebito WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE crebito OWNER TO myuser;
